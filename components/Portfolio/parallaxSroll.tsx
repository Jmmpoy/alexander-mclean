...
export const ParallaxScroll = ({
  ...
  const fourthPart = images.slice(third, 2 * third);

  const parts = [firstPart, secondPart, thirdPart, fourthPart];
  ...
  return (
    ...
    >
      <div
        className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 items-start mx-auto gap-10 pt-40  px-10"
        ref={gridRef}
      >
